...
@synthesize btnBack,btnCamera,btnDoneCroping,btnImagePicker,btnUndo,btnCameraReverse, isTakePicture,viewBlackBackground,lastScale;
...
//            cameraPreview.frame = imgvCrop.frame;
//
//            CGAffineTransform transform = CGAffineTransformScale([cameraPreview transform], lastScale, lastScale);
//            
//            cameraPreview.transform = transform;
//        }
...
- (IBAction)btnCropDoneTap:(id)sender
{
    ...
    {
        // add this lines
        UIImage *cropedImageWithBorder = [mzCroppableView deleteBackgroundOfImageWithBorder:imgvCrop];
        
        UIImage *cropedImage  = [self imageWithShadowForImage:cropedImageWithBorder];
        
        UIImage *cropedImageWithoutBorder = [mzCroppableView deleteBackgroundOfImage:imgvCrop];
