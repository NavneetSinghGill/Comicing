...
{
    NSMutableArray *allStickers = [[NSUserDefaults standardUserDefaults] objectForKey:SKeySticker];
    
    NSMutableArray *array = [[NSMutableArray alloc] init];
    
    for (NSString *imageName in allStickers)
    {
        NSString* fileName = [NSString stringWithFormat:@"%@.png",[imageName lastPathComponent]];
        NSArray *arrayPaths =
...
- (NSArray *)getStickerWithShadow
{
    ...
    for (NSString *imageName in allStickers)
    {
        NSString *fileNameWithBorder = [NSString stringWithFormat:@"%@-withBorder.png",[imageName lastPathComponent]];
