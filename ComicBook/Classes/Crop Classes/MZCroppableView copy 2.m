...
//    mask = [UIImage resizeImage:mask newSize:CGSizeMake(rect.size.width/2, rect.size.height/2)];
//    UIImage* tempImage = image.image;
//    tempImage = [UIImage resizeImage:tempImage newSize:CGSizeMake(rect.size.width/2, rect.size.height/2)];
    NSLog(@"==4");
...
//    CGImageRef imageRef = CGImageCreateWithImageInRect(image.image.CGImage, croppedRect);
//    UIImage* temp = [UIImage imageWithCGImage:imageRef];
////    maskedImage = [UIImage imageWithCGImage:imageRef];
    
//    maskedImage =  [maskedImage imageByTrimmingTransparentPixels];
//    NSData *pngData = UIImagePNGRepresentation(mask);
//    NSArray *paths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
//    NSString *documentsPath = [paths objectAtIndex:0]; //Get the docs directory
//    NSString *filePath = [documentsPath stringByAppendingPathComponent:@"image_maskedImage.png"]; //Add the file name
...
- (UIImage *)deleteBackgroundOfImageWithBorder:(UIImageView *)image withOutBorderImage:(UIImage **)imgWithOutBorder
{
    ...
    //Ramesh Test code
//    UIImageView* sampleImg = image;
//    CAShapeLayer *maskLayer1 = [CAShapeLayer layer];
//    maskLayer1.frame = sampleImg.image.size;
//    maskLayer1.path = [self.croppingPath CGPath];
//    
//    // Add mask
//    sampleImg.layer.mask = maskLayer1;
//    NSData *pngData = UIImagePNGRepresentation(sampleImg.image);
//    
//    NSArray *paths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
//    NSString *documentsPath = [paths objectAtIndex:0]; //Get the docs directory
...
//    NSLog(@"filePath %@",filePath);
//    [pngData writeToFile:filePath atomically:YES];
    //Ramesh Test code --- END
    
    //Handle With out Border Image
...
//    NSData *pngData = UIImagePNGRepresentation(borderImage);
//    NSArray *paths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
//    NSString *documentsPath = [paths objectAtIndex:0]; //Get the docs directory
//    NSString *filePath = [documentsPath stringByAppendingPathComponent:@"image.png"]; //Add the file name
//    NSLog(@"filePath %@",filePath);
...
//    UIGraphicsEndImageContext();
    NSLog(@"==14");
//    UIImage *whiteflippedImage = [self maskImage:whiteImage withMask:borderImage];
    NSLog(@"==14.1");
